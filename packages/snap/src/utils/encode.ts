...
const encodeBuffer = (val: Buffer | Uint8Array, enc: ByteEncoding = 'base58') => {
    if (enc === 'base58') {
...
export { encodeAddress, decodeAddress, hexToUint8Array, uint8ArrayToHex, fromNumber, fromBigInt, fromHexString, bufferOrB58, decodeToBytes, encodeBuffer };
